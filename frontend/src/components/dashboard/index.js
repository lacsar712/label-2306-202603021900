...
import ChannelTopList from './ChannelTopList.vue';
...
export const COMPONENT_MAP = {
  ...
  CHANNEL_TOP_LIST: ChannelTopList,
...
export const COMPONENT_META = {
  ...
  CHANNEL_TOP_LIST: { name: 'TOP5 获客渠道', icon: 'Trophy', defaultWidth: 3, defaultHeight: 6, minWidth: 3, maxWidth: 12, minHeight: 4, maxHeight: 12 },
  CHANNEL_ALERTS: { name: '渠道异常预警', icon: 'Warning', defaultWidth: 12, defaultHeight: 3, minWidth: 6, maxWidth: 12, minHeight: 2, maxHeight: 6 },
